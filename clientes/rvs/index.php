...
<html>
    ...
    <body>
        ...
        <div id="page">
            ...
            <nav class="gtco-nav main-nav" role="navigation">
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-content-inner active" data-content="signup">
                                                    <h3 class="cursive-font">Solicite um orçamento</h3>
                                                    <form action="#" method="POST">
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <label for="activities">Serviço</label>
                                                                <input type="text" name="servico" class="form-control" required="required" />
                                                        ...
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <label for="date-start">Descrição</label>
            ...
            <div class="gtco-section">
                <div class="gtco-container" id="servicos">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2 text-center gtco-heading">
                            <h2 class="cursive-font primary-color">Serviços</h2>
                            <p>Aqui estão algumas fotos dos serviços que realizamos.</p>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center gtco-heading animate-box">
                            ...
                            <p>
                                ...
                                Se você está pensando em realizar o sonho da casa própria, não deixe de fazer um orçamento com a gente, pois será uma prazer atendê-lo. 
                            </p>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-12 text-center gtco-heading animate-box">
                            <h2 class="cursive-font">Serviços prestados na área de projetos</h2>
                        </div>
                        <div class="col-md-4 col-sm-6">
                            <div class="feature-center animate-box" data-animate-effect="fadeIn">
                                ...
                                <h3>Elaboração de projeto estrutural</h3>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6">
                            <div class="feature-center animate-box" data-animate-effect="fadeIn">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="feature-center animate-box" data-animate-effect="fadeIn">
                                ...
                                <h3>Aprovação de projeto de prefeitura</h3>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="feature-center animate-box" data-animate-effect="fadeIn">
                                ...
                                <h3>Levantamento de custos (materiais e serviços)</h3>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6">
                            <div class="feature-center animate-box" data-animate-effect="fadeIn">
                                ...
                                <h3>Serviços prestados na execução de obras</h3>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6">
                            <div class="feature-center animate-box" data-animate-effect="fadeIn">
                ...
                <div class="gtco-container text-center">
                    <div class="display-t">
                        <div class="display-tc">
                            <h1>Serviço com miniescavadeira</h1>
                            <p>Escavações de baldrames e piscinas, valas para drenos e encanamentos e perfuração de brocas.</p>
                        </div>	
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 animate-box" data-animate-effect="fadeInUp">
                            <div class="feature-center">
                                ...
                                <span class="counter-label">Escavações</span>
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d29377.66366124278!2d-48.02512597273316!3d-23.016135437193018!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94c65e7bb1ccec45%3A0x2917fd384408f032!2sConchas%2C+SP%2C+18570-000!5e0!3m2!1spt-BR!2sbr!4v1527888541868" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>

            <footer id="gtco-footer" role="contentinfo" style="background-image: url(images/img_bg_1.jpg)" data-stellar-background-ratio="0.5">
                <div class="overlay"></div>
                <div class="gtco-container" id="contato">
